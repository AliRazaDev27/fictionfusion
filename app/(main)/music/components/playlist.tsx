            ...
            <div className='flex flex-col gap-2'>
                {
                    playlist && playlist.length > 0 && playlist.map((playlist: any, index: number) => (
                        <div key={index} className='w-full ps-4 flex items-center justify-between'>
                            <button
<<<<<<< HEAD:app/music/components/playlist.tsx
                                className='bg-black cursor-pointer hover:scale-105 transition-transform duration-100 shadow-sm shadow-neutral-600 px-4 py-2 text-white rounded-xl'
=======
                                className='bg-slate-700 cursor-pointer hover:scale-105 transition-transform duration-100 px-4 py-2 text-white rounded-3xl'
>>>>>>> f370ba3651d66ac7da1301f305bfefe6c0b19222:app/(main)/music/components/playlist.tsx
                                onClick={(event) => {
